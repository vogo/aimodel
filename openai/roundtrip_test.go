...
var wireTypes = map[string]any{
	...
	"ChatCompletionFunctionCall":           ChatCompletionFunctionCall{},
	"ChatCompletionMessage":                ChatCompletionMessage{},
	"ChatCompletionRequest":                ChatCompletionRequest{},
	"ChatCompletionResponse":               ChatCompletionResponse{},
	"ChatCompletionTool":                   ChatCompletionTool{},
	"ChatCompletionToolCall":               ChatCompletionToolCall{},
	...
	"ResponseCodeInterpreterCall":          ResponseCodeInterpreterCall{},
	"ResponseCodeInterpreterContainerAuto": ResponseCodeInterpreterContainerAuto{},
	"ResponseCodeInterpreterOutput":        ResponseCodeInterpreterOutput{},
	"ResponseContent":                      ResponseContent{},
	"ResponseContextManagement":            ResponseContextManagement{},
	"ResponseConversation":                 ResponseConversation{},
	"ResponseError":                        ResponseError{},
	"ResponseFileSearchCall":               ResponseFileSearchCall{},
	"ResponseFileSearchHybridSearch":       ResponseFileSearchHybridSearch{},
	"ResponseFileSearchRankingOptions":     ResponseFileSearchRankingOptions{},
	"ResponseFileSearchResult":             ResponseFileSearchResult{},
	"ResponseFunctionCallOutput":           ResponseFunctionCallOutput{},
	"ResponseFunctionToolCall":             ResponseFunctionToolCall{},
	"ResponseIncompleteDetails":            ResponseIncompleteDetails{},
	"ResponseInput":                        ResponseInput{},
	"ResponseInputAudio":                   ResponseInputAudio{},
	"ResponseInputItem":                    ResponseInputItem{},
	"ResponseInputMessage":                 ResponseInputMessage{},
	"ResponseInputTokensDetails":           ResponseInputTokensDetails{},
	"ResponseItemReference":                ResponseItemReference{},
	"ResponseLogprob":                      ResponseLogprob{},
	"ResponseMessageContent":               ResponseMessageContent{},
	"ResponseModeration":                   ResponseModeration{},
	"ResponseModerationConfig":             ResponseModerationConfig{},
	"ResponseModerationPolicy":             ResponseModerationPolicy{},
	"ResponseModerationPolicySide":         ResponseModerationPolicySide{},
	"ResponseModerationResult":             ResponseModerationResult{},
	"ResponseOutputItem":                   ResponseOutputItem{},
	"ResponseOutputMessage":                ResponseOutputMessage{},
	"ResponseOutputTokensDetails":          ResponseOutputTokensDetails{},
	"ResponsePrompt":                       ResponsePrompt{},
	"ResponsePromptCacheBreakpoint":        ResponsePromptCacheBreakpoint{},
	"ResponsePromptCacheOptions":           ResponsePromptCacheOptions{},
	...
	"ResponseStreamOptions":                ResponseStreamOptions{},
	"ResponseTextConfig":                   ResponseTextConfig{},
	"ResponseTextFormat":                   ResponseTextFormat{},
	"ResponseTool":                         ResponseTool{},
	"ResponseToolChoiceAllowed":            ResponseToolChoiceAllowed{},
	"ResponseToolChoiceCustom":             ResponseToolChoiceCustom{},
	"ResponseToolChoiceFunction":           ResponseToolChoiceFunction{},
	"ResponseToolChoiceMCP":                ResponseToolChoiceMCP{},
	"ResponseToolChoiceTypes":              ResponseToolChoiceTypes{},
	"ResponseTopLogprob":                   ResponseTopLogprob{},
	"ResponseUsage":                        ResponseUsage{},
	"ResponseWebSearchAction":              ResponseWebSearchAction{},
	"ResponseWebSearchCall":                ResponseWebSearchCall{},
	"ResponseWebSearchSource":              ResponseWebSearchSource{},
	"ResponseWebSearchUserLocation":        ResponseWebSearchUserLocation{},
...
// wireSample supplies values for the types whose JSON form is backed by
// unexported state.
func wireSample(t reflect.Type) (reflect.Value, bool) {
	switch t {
	case reflect.TypeFor[ChatCompletionContent]():
		return reflect.ValueOf(NewTextContent("x")), true
	case reflect.TypeFor[ResponseInput]():
		return reflect.ValueOf(*NewResponseTextInput("x")), true
	case reflect.TypeFor[ResponseMessageContent]():
		return reflect.ValueOf(NewResponseTextContent("x")), true
	}
