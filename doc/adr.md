...
| [0009](./adr/0009-stateful-active-endpoint-with-in-call-retry.md) | Accepted | A pool has one active endpoint, serves one call at a time, and retries in place before replacing it |
