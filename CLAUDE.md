...
|---|---|---|
| Anything cross-cutting: canonical representation, registry dispatch, client options, env fallback | [doc/api.md](./doc/api.md) | `client.go`, `chat.go`, `ais/provider.go`, `ais/registry.go` |
